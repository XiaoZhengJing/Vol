  ...
  , {
    ...
    component:  () => import('@/views/appmanager/App_NewsEditor.vue' )
      ...
      ,{
        path: '/LTB_Project',
        name: 'LTB_Project',
        component: () => import('@/views/ltb/project/LTB_Project.vue')
    }
    ,{
      path: '/LTB_SeriesDemands',
      name: 'LTB_SeriesDemands',
      component: () => import('@/views/ltb/project/LTB_SeriesDemands.vue')
  }
  ,{
    path: '/LTB_ServiceDemands',
    name: 'LTB_ServiceDemands',
    component: () => import('@/views/ltb/project/LTB_ServiceDemands.vue')
}

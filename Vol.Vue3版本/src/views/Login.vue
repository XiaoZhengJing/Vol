      ...
      <div class="l-left">
        <div class="desc">
          ...
          <!-- <div style="margin-top: 30px">
            <a href="https://github.com/cq-panda/Vue.NetCore" target="_blank" style="
                color: #ffff;
              ...
              <span>GitHub</span></a>
            <a href="https://gitee.com/x_discoverer/Vue.NetCore" target="_blank" style="
                color: #ffff;
                border: 1px solid #ffff;
                width: 80px;
                margin-right: 5px;
              " class="index-btn ivu-btn ivu-btn-primary ivu-btn-circle ivu-btn-ghost">
              <span>Gitee</span></a>
            <a @click="$message.info('即将开放')" style="
                color: #ffff;
                border: 1px solid #ffff;
                width: 80px;
                margin-right: 5px;
              ...
              " class="index-btn ivu-btn ivu-btn-primary ivu-btn-circle ivu-btn-ghost">
              <span>框架小程序</span></a>
            <a href="http://v2.volcore.xyz/document/guide" target="_blank" style="color: #ffff; border: 1px solid #ffff"
              class="index-btn ivu-btn ivu-btn-primary ivu-btn-circle ivu-btn-ghost">
              <span>框架文档</span></a>
          </div> -->
        </div>
...
export default {
  ...
  created() {
    ...
    if (this.$route.query.gid != null && this.$route.query.encrypt != null) {
      this.userInfo.userName = this.$route.query.gid;
      this.userInfo.passWord = this.$route.query.encrypt;
      debugger
      this.login();
    } else {
      window.location.href =
        "https://shai100a.ad005.onehc.net/WindowsAuth/auth?returnUrl=" +
        window.location.href;
    }
  },
  methods: {
    ...
    login() {
      ...
      this.loading = true;
      this.http
        .post('/api/user/windowslogin', this.userInfo, '正在登录....')
        .then((result) => {
          if (!result.status) {
            this.loading = false;
            // this.getVierificationCode();
